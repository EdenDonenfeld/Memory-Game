...
public class ExpertGameActivity extends AppCompatActivity {
    ...
    private void LoadImages() {
        ...
        cards.add(findViewById(R.id.card17));
        cards.add(findViewById(R.id.card18));
        cards.add(findViewById(R.id.card19));
        cards.add(findViewById(R.id.card20));
        cards.add(findViewById(R.id.card21));
        cards.add(findViewById(R.id.card22));
        cards.add(findViewById(R.id.card23));
        cards.add(findViewById(R.id.card24));
    }
        ...
        for (int i = 0; i < NUMBER_OF_CARDS; i++) {
            ...
            switch(rndNumber) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    cardImages.add(R.drawable.card9);
                    break;
                case 9:
                    cardImages.add(R.drawable.card10);
                    break;
                case 10:
                    cardImages.add(R.drawable.card11);
                    break;
                case 11:
                    cardImages.add(R.drawable.card12);
                    break;
            }
        }
    }
